...
HD_PWD='C:/Users/admin/Desktop/project/Digital-_design_-project/Digital-_design_-project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log max_diff.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source max_diff.tcl -notrace
